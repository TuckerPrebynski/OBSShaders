...
source_info = {}
source_info.id = 'filter-kuwa'              -- Unique string identifier of the source type
...
source_info.create = function(settings, source)
  ...
  local effect_file_path = script_path() .. 'filter-kuwa.effect.hlsl'
  ...
  data.params.sharpness = obs.gs_effect_get_param_by_name(data.effect, "sharpness")
...
source_info.get_properties = function(data)
  ...
  obs.obs_properties_add_int_slider(props, "box_radius", "Radius of the Kuwahara window", 2, 20, 1)
